...
# Copy all mirrored files to the specified directory
cp -r /config/* /home/bat/Desktop/WebSites

echo "Mirrored files copied to /home/bat/Desktop/WebSites successfully."
